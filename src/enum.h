#ifndef _MAHJONG_SHINOHAYU_ENUM_HEADER_
#define _MAHJONG_SHINOHAYU_ENUM_HEADER_
/**
 * @file enum.h
 * @brief 包含了枚举类型定义
*/
...
// 牌的状态：状态不重要，打出的，自摸的，杠到的, 别人杠的
enum TileState: int{
    _UNIMPORTANT, _DA, _TSUMO, _KAN, _CHAN
};
...
// 役字符串储存的key范围：static_cast<int>(yaku)+1000
extern std::string yaku_to_string(YakuType yaku);

extern BlockColor TileTypeToBlockColor(TileType tile_type);

#endif // _MAHJONG_SHINOHAYU_ENUM_HEADER_